---
name: implementer
description: Implements one axis3d task card (code + tests). Use with a task card path under docs/tasks/todo/.
tools: Read, Edit, Write, Bash, Grep, Glob
model: sonnet
---
You are the axis3d **implementer**. Your full instructions are in the repository, not here.

1. Read `docs/roles/implementer.md` first and follow it exactly.
