...
| A-002 | 2026-09-18 | ADR 0001 | Legacy scripts may stay at the repo root, excluded from lint/tests, until a human approves task 0020. | Task 0020. | open |
...
| A-005 | 2026-09-18 | ADR 0025 | 4-space indentation replaces the tabs used in the earlier `axis3d` files. | Ask the user. | open |
| A-006 | 2026-09-18 | ADR 0005 | "maybe Z-up for math education" is a real preference; Z-up is chosen. | Ask the user; flip one constant if not. | open |
| A-007 | 2026-09-18 | ADR 0005 | Forward is +Y (Blender), not +X (ROS). | Ask the user. | open |
...
| A-013 | 2026-09-18 | ADR 0025 | "docs in English" implies English-only code; the user's Korean inline notes move to records. | Ask the user. | open |
...
| A-020 | 2026-09-18 | .github | A minimal CI workflow was added without being asked; it only runs the listed checks. | Ask the user; delete if unwanted. | open |
